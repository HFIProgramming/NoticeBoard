        ...
        <div class="top-bar" id="top-bar">
            ...
            <div class="top-bar-right">
                <ul class="menu">
                    ...
                    @else
                        <li>
                            <a class="button" type="button" data-toggle="notifications-dropdown">
                        ...
                        <li>
                            <a class="button" type="button" data-toggle="options-dropdown">
                                <img class="" src="{{ Auth::user()->avatar }}" alt="My avatar">
                            </a>
